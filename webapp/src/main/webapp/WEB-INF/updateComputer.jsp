...
<section id="main" class="col-md-6 col-md-offset-3">
	<h1><spring:message code="title.update" /></h1>
	
	<form:form  commandName="compDto" class="form-horizontal" id="formValidation" action="update" method="POST">
		<div class="control-group">
				<form:label path="name"><spring:message code="form.computername" /></form:label>
				<div class="controls">
					<form:input path="id" type="hidden" class="form-control" id="id" value="${compDto.id}"/>
					<form:input path="name" class="form-control" id="inputName" value="${compDto.name}"/>
		...
		<div class="control-group">
				...
				<div class="controls">
					<form:input path="introduced" class="form-control datepicker" value="${compDto.introduced}"/>
		...
		<div class="control-group">
				...
				<div class="controls">
					<form:input path="discontinued" class="form-control datepicker" value="${compDto.discontinued}"/>
		...
		<div class="actions">
			<input type="submit" value="<spring:message code="form.update" />" class="btn btn-primary">
